(function () {
  ...
  async function renderProject() {
    ...
    // Create the AudioContext synchronously, right inside the click handler,
    // before any "await". Browsers tie audio playback permission to the
    // user-gesture moment — creating it after awaiting fonts/images can
    // silently block background music or mic input from playing.
    let audioCtx = null;
    ...
    let dest = null, musicEl = null, micStream = null;
    try {
    ...
    recorder.onerror = (e) => {
      ...
      // Don't let a mid-recording error leave the spinner stuck forever —
      // stop and salvage whatever chunks were captured so far.
